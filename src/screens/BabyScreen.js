...
import {
  View, Text, StyleSheet, ScrollView, TouchableOpacity, Alert, Modal, Platform, Image, TextInput,
} from 'react-native';
...
export default function BabyScreen() {
  ...
  async function loadData() {
    ...
    const custom = await getCustomReminders('baby');
            ...
            {customReminders.length > 0 && (
              <>
                ...
                {customReminders.map(item => (
                  <View key={item.id} style={[styles.vaccineCard, item.completed && styles.completedCard]}>
                    <View style={styles.vaccineHeader}>
                      <View style={[styles.statusDot, {
                      ...
                      <View style={styles.vaccineInfo}>
                        ...
                        <Text style={styles.vaccineAge}>{formatCustomDate(item.date, item.hour, item.minute)}</Text>
                      </View>
                      <TouchableOpacity
